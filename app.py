...
async def index(request: Request):
    ...
    """
    return templates.TemplateResponse("templates/vehicledata.html",{"request": request, "context": "Rendering"})
...
async def predictRouteClient(request: Request):
    ...
    try:
        ...
        status = "Interested in buying insurance" if value == 1 else "Not interested in buying insurance"
