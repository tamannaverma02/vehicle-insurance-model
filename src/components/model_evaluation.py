...
class ModelEvaluation:
    ...
    def evaluate_model(self) -> EvaluateModelResponse:
        ...
        try:
            ...
            #apply same transformations as training on test data 
            ...
            tmp_best_model_score = 0 if best_model_f1_score is None else best_model_f1_score # when first model is added set best score to 0
